...
export interface CounterpartyBlockResponse {
  /**
   * Unique identifier of the counterparty.
   */
  id: string;
   ...
   */
  financial_address:
    | CounterpartyBlockResponse.IbanFinancialAddress
    | CounterpartyBlockResponse.SortCodeFinancialAddress
    | CounterpartyBlockResponse.AbaFinancialAddress
    | CounterpartyBlockResponse.BicFinancialAddress
    | CounterpartyBlockResponse.CryptoWalletFinancialAddress;
   ...
   * Physical address of the counterparty, or null if not recorded.
   */
  physical_address: CounterpartyBlockResponse.PhysicalAddress | null;
...
export namespace CounterpartyBlockResponse {
  export interface IbanFinancialAddress {
    /**
     * Name of the account holder.
     */
