...
export class AccountOpenings extends APIResource {
  /**
   * Starts an asynchronous account opening and returns an account_opening resource
   * in received status.
   */
  create(
    body: AccountOpeningCreateParams,
    options?: RequestOptions,
  ): APIPromise<AccountOpeningCreateResponse> {
    return this._client.post('/v1/account_openings', { body, ...options });
  }
}

export interface AccountOpeningCreateResponse {
  /**
...
export interface AccountOpeningCreateParams {
  /**
   ...
   */
  beneficiary_data:
    | AccountOpeningCreateParams.UsBeneficiaryData
    | AccountOpeningCreateParams.NonUsBeneficiaryData;
}

export namespace AccountOpeningCreateParams {
...
export declare namespace AccountOpenings {
  export {
